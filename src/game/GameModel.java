...
public class GameModel {
    ...
    public void spawnObjects() {
        ...
        int randomCheck = random.nextInt(100);
        boolean spawnAsteroid = randomCheck < spawnRate;

        // Determine asteroid x-coordinate
        ...
        // Determine power-up x-coordinate
    ...
    public void fireBullet() {
        ...
        if (ship != null) {
            ...
            Bullet bullet = new Bullet(5, 10); // Default position
            addObject(bullet);
            logger.log("Core.Bullet fired!");
        }
    }
